...
<p>Cliquez <a href="index.php?controller=user&action=connectForm">ici</a> pour accéder à la page de connexion</p>
<p>Cliquez <a href="index.php?controller=user&action=inscription">ici</a> pour accéder à la page d'inscription</p>
